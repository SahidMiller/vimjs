...
if (opts.h || opts.help) {
...
} else if (opts.perf && opts.perf.profile && process.execArgv.indexOf("--prof") === -1) {
  ...
  var blessed = require("./editor").BaseWidget.blessed;
  ...
  module.exports = function (options) {
    ...
    ]).then(async function ([userDir, stdin]) {
      if (userDir)
        opts = _.merge(
